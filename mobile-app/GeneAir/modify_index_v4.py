...
if 'setSpo2History' not in content:
...
ui_replace = """            {/* Vitals Charts Container */}
...
content = re.sub(
    r"<Text style=\{\{ fontSize: 14, fontWeight: '600', color: '#172752', marginBottom: 8 \}\}>Heart Rate Trend</Text>.*?</View>\s*</View>\s*</View>",
    ui_replace + "\n          </View>",
    content,
    flags=re.DOTALL
)
